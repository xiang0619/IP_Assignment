      ...
      <tbody class="table-light">
        <xsl:for-each select="staffs/staff">
          <tr>
            ...
            <td><xsl:value-of select="staff_mobile"/></td>
            <td><xsl:value-of select="staff_updateID"/></td>
            <td><xsl:value-of select="staff_updateDate"/></td>
            <td><xsl:value-of select="staff_createID"/></td>
            <td><xsl:value-of select="staff_createDate"/></td>
          </tr>
        </xsl:for-each>
      </tbody>
    </table>
