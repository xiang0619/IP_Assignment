            ...
            <div class="container-fluid row">
                ...
                <div class="col text-end fs-5">
                    ...
                    if (isset($_SESSION['customerID'])) {
                        ...
                        $title = "Login";
                        $link = "http://localhost/IP_Assignment/CustomerLogin.php";
                    }
                    ?>
                    ...
                    <a title="Log Out" href="http://localhost/IP_Assignment/Shared/PHP/Logout.php">
                        <?php
                        if (isset($_SESSION['customerID'])) {
                            echo '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right secondary-color icon-size" viewBox="0 0 16 16">"'
