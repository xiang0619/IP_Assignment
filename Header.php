        ...
        <nav class="navbar navbar-expand-lg primary-background-color">
            <div class="container-fluid row">
                <div class="col text-start fs-4">
                    <a href="tel:+6011-3610 6802" title="011-360 6802">
                ...
                <div class="col text-end fs-4">
                    ...
                    <a title="Login" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill secondary-color icon-size" viewBox="0 0 16 16">
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <img src="Shared/Image/29385188.png" width="100px" height="110px" alt="Logo"/>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                            <a class="nav-link fs-5" href="#">Stationery</a>
                      </li>
                      <li class="nav-item">
